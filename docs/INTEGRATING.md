...
batching helpers. List your ids and invoke names in the project
instructions. The MCP process holds one `AgentClient` and reuses a
single TCP session across `tools/call`.
